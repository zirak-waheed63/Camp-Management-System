...
class CampsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post camps_url, params: { camp: { end_date: @camp.end_date, name: @camp.name, start_date: @camp.start_date } }
    end
  ...
  test "should update camp" do
    patch camp_url(@camp), params: { camp: { end_date: @camp.end_date, name: @camp.name, start_date: @camp.start_date } }
